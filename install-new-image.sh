...
set KERNEL_LINE rd.kiwi.install.pass.bootparam rd.kiwi.install.image=\${HTTP_STATE}/\${IMAGE_NAME} \${KERNEL_ARG} BOOTIF=01-\${mac:hexhyp} razorurl=\${HTTP_BASE}/post-install?id=@id@&bootid=@bootid@
